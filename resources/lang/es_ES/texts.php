...
$LANG = array(
    ...
    'email_from' => 'El equipo de Evoice ',
    ...
    'agree_to_terms' => 'Estoy de acuerdo con los términos de Evoice :terms',
    ...
    'pro_plan_success' => '¡Gracias por unirte a Evoice! Al realizar el Pago de tu Factura, se iniciara tu PLAN PRO.',
    ...
    'invitation_message' => ':invitor te ha invitado a unirte a su cuenta en Evoice.',
    ...
    'app_description' => 'Evoice es una solución open-source gratuita para manejar la facturación de tus clientes. Con Evoice, se pueden crear y enviar hermosas facturas desde cualquier dispositivo que tenga acceso a Internet. Tus clientes pueden imprimir tus facturas, descargarlas en formato PDF o inclusive pagarlas en linea desde esta misma plataforma.',
    'rows' => 'filas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature4' => 'Eliminar "Creado por Evoice"',
...
<li>Hoy es el viernes, la fecha límite es el primer viernes después. La fecha de vencimiento será el próximo viernes, no hoy.</li></ul>',
    ...
    'white_label_text' => 'Compra UN AÑO de Licencia de Marca Blanca por $:price y elimina la marca Evoice de la Factura y del Portal de Cliente.',
    ...
    'pro_plan_remove_logo' => ':link haz click para eliminar el logo de Evoice',
    ...
    'pro_plan_year_description' => 'Un año de inscripción en el Plan Evoice Pro.',
    'pro_plan_month_description' => 'Un mes de inscripción en el Plan Evoice Pro.',
    'enterprise_plan_product' => 'Plan Enterprise ',
    'enterprise_plan_year_description' => 'Un año de inscripción en el Plan Evoice Enterprise .',
    'enterprise_plan_month_description' => 'Un mes de inscripción en el Plan Evoice Enterprise .',
...
Una vez que tenga los montos, vuelva a esta página de métodos de pago y haga clic en "Verificación completa" junto a la cuenta.',
    ...
    'export_help' => 'Utilice JSON si planea importar los datos en  Evoice.<br/>El fichero incluye clientes, productos, facturas, presupuestos y pagos.',
    ...
    'wepay_account_description' => 'Pasarela de Pago para Evoice',
    ...
    'bot_get_email' => '¡Hola! (wave) <br/>Gracias por probar el Bot Evoice. <br/>Necesitas crear una cuenta gratuita en <a href="https://www.invoiceninja.com">invoiceninja.com</a> para usar este bot.<br/>Envíanme la dirección de correo electrónico de tu cuenta para comenzar.',
...
Eso es todo, tu cuenta está verificada.<br/>',
    ...
    'security_code_email_subject' => 'Código de seguridad para Evoice Bot',
    'security_code_email_line1' => 'Este es su código de seguridad Evoice Bot.',
    ...
    'update_invoiceninja_title' => 'Actualizar Evoice',
    'update_invoiceninja_warning' => '¡Antes de comenzar a actualizar Evoice cree una copia de seguridad de su base de datos y archivos!',
    'update_invoiceninja_available' => 'Está disponible una nueva versión de Evoice.',
    'update_invoiceninja_unavailable' => 'No hay ninguna versión nueva de Evoice.',
