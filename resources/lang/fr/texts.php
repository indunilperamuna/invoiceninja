...
$LANG = array(
    ...
    'pro_plan_feature4' => 'Retirer "Created by Evoice"',
    ...
    'white_label_text' => 'Achetez une licence en marque blanche d\'UN AN au coût de $:price pour retirer la marque de Evoice des factures et du portail client.',
    ...
    'pro_plan_year_description' => 'Engagement d\'un an dans le Plan Evoice Pro.',
    'pro_plan_month_description' => 'Engagement d\'un mois dans le Plan Evoice Pro.',
    'enterprise_plan_product' => 'Plan Entreprise',
    'enterprise_plan_year_description' => 'Engagement d\'un an dans le Plan Evoice Entreprise.',
    'enterprise_plan_month_description' => 'Engagement d\'un mois dans le Plan Evoice Entreprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez d\'importer des données dans Evoice.<br/>Le fichier inclut les clients, les produits, les factures, les offres et les paiements.',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci de vouloir essayer le Bot de Evoice.<br/>Tu dois créer un compte gratuit à <a href="https://www.invoiceninja.com">invoiceninja.com</a> pour pouvoir utiliser ce bot.<br/>Envoie-moi l\'adresse courriel de ton compte pour commencer.',
    ...
    'update_invoiceninja_warning' => 'Avant de commencer une mise à jour d\'Evoice, créez une sauvegarde de votre base de données et de vos fichiers!',
