...
<li>"เงินประกันสำหรับ :QUARTER+1" => " ดำเนินการชำระเงินในไตรมาศที่ 2"</li>
    ...
    'pro_plan_success' => 'ขอขอบคุณที่เลือกแผน Pro Pro ของ Evoice!<p/>&nbsp;<br/>
...
-- ส่งอีเมลมาที่ contact@invoiceninja.com',
    ...
    'app_description' => 'Evoice เป็นโซลูชันโอเพนซอร์สฟรีสำหรับลูกค้าที่ออกใบแจ้งหนี้และเรียกเก็บเงิน ด้วย Evoice คุณสามารถสร้างและส่งใบแจ้งหนี้ที่สวยงามได้จากอุปกรณ์ใด ๆ ที่สามารถเข้าถึงเว็บได้ ลูกค้าของคุณสามารถพิมพ์ใบแจ้งหนี้ของคุณดาวน์โหลดเป็นไฟล์ PDF และคุณจ่ายเงินออนไลน์จากภายในระบบของเราได้เลย',
    'rows' => 'แถว',
    'www' => 'www',
    'logo' => 'www',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'เอา  "Created by Evoice" ออก',
...
แปลงใบเสนอราคาให้เป็นใบแจ้งหนี้โดยอัตโนมัติเมื่อได้รับอนุมัติจากลูกค้า',
    ...
    'pro_plan_remove_logo' => ':link ลบโลโก้ Evoice โดยการเข้าร่วม Pro Plan',
    ...
    'pro_plan_year_description' => 'การลงทะเบียนหนึ่งปีสำหรับ   Evoice Pro Plan',
    'pro_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Evoice Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'ลงทะเบียนหนึ่งปีสำหรับ Evoice Enterprise Plan.',
    'enterprise_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Evoice Enterprise Plan.',
    ...
    'export_help' => 'ใช้ JSON ถ้าคุณวางแผนที่จะนำเข้าข้อมูลลงใน Evoice. <br/> ไฟล์ประกอบด้วยลูกค้า, สินค้า, ใบแจ้งหนี้, ใบเสนอราคา และการชำระเงิน.',
    'JSON_file' => 'JSON File',
    ...
    'wepay_account_description' => 'เกตเวย์การชำระเงินสำหรับ Evoice',
    ...
    'bot_get_email' => 'Hi(Wave)<br/>ขอขอบคุณที่ลองบอท Evoice<br/>คุณต้องสร้างบัญชีฟรีบน<a href="https://www.invoiceninja.com">invoiceninja.com</a>เพื่อใช้บอท.<br/>ส่งที่อยู่อีเมลบัญชีของคุณเพื่อเริ่มต้นใช้งาน',
    ...
    'security_code_email_subject' => 'รหัสรักษาความปลอดภัยสำหรับ  Evoice Bot',
    ...
    'update_invoiceninja_title' => 'อัปเดท Evoice',
    'update_invoiceninja_warning' => 'ก่อนที่จะเริ่มต้นการอัพเกรด Evoice กรุณาสำรองฐานข้อมูลและไฟล์ของคุณ!',
    'update_invoiceninja_available' => 'มีเวอร์ชันใหม่ของ Evoice ให้ใช้งาน',
    'update_invoiceninja_unavailable' => 'ไม่มีเวอร์ชันใหม่ของ Evoice available.',
