...
$LANG = array(
    ...
    'app_description' => 'Evoice is een gratis, open-source oplossing voor het maken en versturen van facturen aan klanten. Met Evoice, kun je gemakkelijk mooie facturen maken en verzenden vanaf elk apparaat met internettoegang. Je klanten kunnen je facturen afdrukken, downloaden als pdf bestand en je zelfs online betalen vanuit het systeem.',
    'rows' => 'rijen',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomein',
    ...
    'pro_plan_feature4' => 'Verwijder "Aangemaakt door Evoice"',
    ...
    'white_label_text' => 'Koop een white label licentie voor één jaar voor $:price om de Evoice reclame te verwijderen van facturen en het klantenportaal.',
    ...
    'pro_plan_year_description' => 'Jaarabonnement op Evoice Pro.',
    'pro_plan_month_description' => 'Maandabonnement op Evoice Pro.',
    'enterprise_plan_product' => 'Zakelijk abonnement',
    'enterprise_plan_year_description' => 'Jaarabonnement op Evoice zakelijk.',
    'enterprise_plan_month_description' => 'Maandabonnement op Evoice zakelijk.',
...
Kom terug naar deze betalingsmethode pagina zodra u de bedragen heeft ontvangen en klik op "Verificatie voltooien" direct naast de rekening.',
    ...
    'export_help' => 'Gebruik JSON als u van plan bent om de gegevens te importeren in Evoice.<br/>Het bestand omvat klanten, producten, facturen, offertes en betalingen.',
...
',
    ...
    'wepay_account_description' => 'Betalings gateway voor Evoice',
    ...
    'bot_get_email' => 'Hallo! (wave)<br/>bedankt om de Evoice Bot uit te proberen.<br/>Je moet een gratis account aanmaken op  <a href="https://www.invoiceninja.com">invoiceninja.com</a> om de bot te kunnen gebruiken.<br/>Stuur me uw e-mailadres om van start te gaan.',
    ...
    'security_code_email_subject' => 'Beveiligingscode voor Evoice Bot',
    'security_code_email_line1' => 'Dit is uw Evoice Bot beveiligingscode.',
    ...
    'self-update' => 'Update',
    'update_invoiceninja_title' => 'Evoice bijwerken',
    'update_invoiceninja_warning' => 'Maak een backup van de database en bestanden vóór het upgraden van Evoice!',
    'update_invoiceninja_available' => 'Een nieuwe versie van Evoice is beschikbaar.',
    'update_invoiceninja_unavailable' => 'Er is geen nieuwe versie van Evoice beschikbaar.',
