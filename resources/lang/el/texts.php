...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" => "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'confirmation_subject' => 'Επιβεβαίωση Λογαριασμού Evoice',
    ...
    'agree_to_terms' => 'Συμφωνώ με τους :terms του Evoice',
    ...
    'pro_plan_success' => 'Ευχαριστούμε που επιλέξατε το Evoice\'s Pro plan!<p/>&nbsp;<br/>
...
να σας βοηθήσουμε. Στείλτε μας email στο contact@invoiceninja.com\',',
    ...
    'pro_plan_feature4' => 'Αφαίρεση του "Created by Evoice"',
    ...
    'pro_plan_remove_logo' => ':link για να αφαιρέσετε το λογότυπο Evoice και να συμμετέχετε στο Επαγγελματικό Πλάνο',
    ...
    'pro_plan_year_description' => 'Ένα έτος εγγραφή στο Επαγγελματικό Πλάνο του Evoice.',
    'pro_plan_month_description' => 'Ένας μήνας εγγραφή στο Επαγγελματικό Πλάνο του Evoice.',
    'enterprise_plan_product' => 'Πλάνο Enterprise',
    'enterprise_plan_year_description' => 'Ένα έτος εγγραφή στο Εταιρικό Πλάνο του Evoice.',
    'enterprise_plan_month_description' => 'Ένας μήνας εγγραφή στο Εταιρικό Πλάνο του Evoice.',
    ...
    'export_help' => 'Χρησιμοποιήστε JSON εάν σχεδιάζετε να εισάγετε δεδομένα στο Evoice.<br/>Το αρχείο περιλαμβάνει πελάτες, προϊόντα, τιμολόγια, προσφορές και πληρωμές.',
    ...
    'wepay_account_description' => 'Πύλη Πληρωμών (Gateway) για το Evoice',
    ...
    'bot_get_email' => 'Γειά! (wave)<br/>Ευχαριστώ που δοκιμάσατε τον αυτοματισμό του Evoice.<br/>Θα πρέπει να δημιουργήσετε ένα δωρεάν λογαριασμό στο <a href="https://www.invoiceninja.com">invoiceninja.com</a> για να χρησιμοποιήσετε αυτό τον αυτοματισμό.<br/>Στείλτε μου την διεύθυνση email σας για να ξεκινήσετε.',
    ...
    'security_code_email_subject' => 'Κωδικός ασφαλείας για τον αυτοματισμό Evoice',
    'security_code_email_line1' => 'Αυτός είναι ο κωδικός ασφαλείας για τον αυτοματισμό Evoice',
    ...
    'update_invoiceninja_title' => 'Ενημέρωση Evoice',
    'update_invoiceninja_warning' => 'Πριν αρχίσετε την αναβάθμιση του Evoice, δημιουργήστε ένα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων!',
    'update_invoiceninja_available' => 'Υπάρχει διαθέσιμη νεότερη έκδοση του Evoice.',
    'update_invoiceninja_unavailable' => 'Δεν υπάρχει νεότερη έκδοση του Evoice διαθέσιμη.',
