...
$LANG = array(
    ...
    'confirmation_subject' => 'Potwierdzenie rejestracji konta w Evoice',
    ...
    'agree_to_terms' => 'Zgadzam sie z warunkami Evoice :terms',
    ...
    'pro_plan_success' => 'Thanks for choosing Evoice\'s Pro plan!<p/>&nbsp;<br/>
    ...
    'app_description' => 'Evoice is a free, open-source solution for invoicing and billing customers. With Evoice, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
    'rows' => 'wierszy',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomena',
    ...
    'pro_plan_feature4' => 'Remove "Created by Evoice"',
    ...
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o Evoice z faktur i portalu klienta.',
    ...
    'pro_plan_remove_logo' => ':link to remove the Evoice logo by joining the Pro Plan',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do Evoice.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    'JSON_file' => 'Plik JSON',
    ...
    'wepay_account_description' => 'Dostawca płatności dla Evoice',
    ...
    'security_code_email_subject' => 'Kod bezpieczeństwa dla Evoice Bot',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj Evoice',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję Evoice stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja Evoice jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja Evoice nie jest dostępna.',
