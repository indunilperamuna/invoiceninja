...
$LANG = array(
    ...
    'pro_plan_success' => 'Ju faleminderit që keni zgjedhur Evoice Pro plan!<p/>&nbsp;<br/>
    ...
    'app_description' => 'Evoice është zgjidhje falas, open-cource për faturim të konsumatorëve. Me Invoice Ninjca, ju lehtësisht mund të krijoni dhe dërgoni fatura të bukura nga cilado pajisje e cila ka qasje në internet. Klientët tuaj mund të printojnë faturat, t\'i shkarkojnë si PDF fajlla apo edhe ti paguajn online brenda sistemit.',
    'rows' => 'rreshta',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Largoni "Krijuar nga Evoice"',
    ...
    'white_label_text' => 'Bli nje license vjecare me cmimin $:price per te hequr logot dhe tekstet e Evoice nga fatura dhe portali i klientit. ',
    ...
    'pro_plan_remove_logo' => ':link për të larguar Evoice logo duke iu bashkangjitur Pro Planit',
...
Fushat e njësive në faturë',
    ...
    'pro_plan_year_description' => 'Regjistrimi një vjeçar në Evoice Pro Plan.',
    'pro_plan_month_description' => 'Regjistrim një mujor në Evoice Pro Plan.',
    'enterprise_plan_product' => 'Plani Enterprise',
    'enterprise_plan_year_description' => 'Regjistrimi një vjeçar në Evoice Enterprise Plan.',
    'enterprise_plan_month_description' => 'Regjistrimi një mujor në Evoice Enterprise Plan.',
...
Pasi të keni pranuar shumat, kthehuni në faqen e metodave të pagesës dhe klikoni "Përfundo Verifikimin" afër llogarisë.',
    ...
    'wepay_account_description' => 'Kanalet e pagesës për Evoice',
    ...
    'bot_get_email' => 'Pershendetje! (wave)<br/>Faleminderit qe provuat Evoice Bot.<br/>You duhet te krijoni nje llogari falas ne <a href="https://www.invoiceninja.com">invoiceninja.com</a> per te perdorur kete bot.?<br/>Me dergoni emailin e llogarise tuaj per te filluar. ',
    ...
    'security_code_email_subject' => 'Kodi i sigurise per Evoice Bot',
    'security_code_email_line1' => 'Ky eshte kodi juaj i sigurise per Evoice Bot. ',
    ...
    'update_invoiceninja_title' => 'Perditeso Evoice',
    'update_invoiceninja_warning' => 'Perpara se te perditesoni Evoice, ruani nje rezerve te skedareve dhe databazes!',
    'update_invoiceninja_available' => 'Nje version i ri i Evoice eshte i disponueshem. ',
    'update_invoiceninja_unavailable' => 'Nuk ka version te ri te disponueshem per Evoice. ',
