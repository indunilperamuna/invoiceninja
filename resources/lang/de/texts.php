...
$LANG = array(
    ...
    'pro_plan_success' => 'Danke, dass Sie Evoice\'s Pro gewählt haben!<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => '"Erstellt durch Evoice" entfernen',
...
<li>Heute ist Freitag, das Fälligkeitsdatum ist der Freitag einer jeden Woche. Das nächste Fälligkeitsdatum entspricht dem nächsten Freitag, also nicht heute.
    ...
    'white_label_text' => 'Kaufen Sie eine Ein-Jahres-"White Label"-Lizenz für $:price um das Evoice Branding von den Rechnungen und dem Kundenportal zu entfernen.',
    ...
    'pro_plan_year_description' => 'Einjährige Registrierung für den Evoice Pro-Plan.',
    'pro_plan_month_description' => 'Einmonatliche Registrierung für den Evoice Pro-Plan.',
    'enterprise_plan_product' => 'Unternehmensplan',
    'enterprise_plan_year_description' => 'Einjährige Registrierung für den Evoice Enterprise-Plan.',
    'enterprise_plan_month_description' => 'Einmonatliche Registrierung für den Evoice Enterprise-Plan.',
...
Sobald Sie die Beträge erhalten haben, kommen Sie bitte wieder zurück zu dieser Zahlungsmethoden-Seite und klicken Sie auf "Complete Verification" neben Ihrem Konto.',
    ...
    'export_help' => 'Nutzen Sie JSON wenn Sie die Daten in Evoice importieren wollen.<br/>Die Datei beinhaltet Kunden, Produkte, Rechnungen, Angebote und Zahlungen.',
    ...
    'wepay_account_description' => 'Zahlungsanbieter für Evoice',
    ...
    'bot_get_email' => 'Hi! (wink)<br/>Danke für den Test des Evoice Bots.<br/>Sie benötigen einen kostenlosen Account auf <a href="https://www.invoiceninja.com">invoiceninja.com</a> um diesen Bot zu nutzen.<br/>Sende mir die E-Mail-Adresse deines Accounts um zu starten.',
    ...
    'security_code_email_subject' => 'Sicherheitscode für Evoice Bot',
    'security_code_email_line1' => 'Dies ist Ihr Evoice Bot Sicherheitscode.',
    ...
    'update_invoiceninja_warning' => 'Vor dem Update von Evoice sollte ein Backup der Datenbank und der Dateien erstellt werden!',
    'update_invoiceninja_available' => 'Eine neue Version von Evoice ist verfügbar.',
    'update_invoiceninja_unavailable' => 'Keine neue Version von Evoice verfügbar.',
