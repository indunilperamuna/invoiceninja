...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekräfta ditt Evoice konto',
    ...
    'agree_to_terms' => 'Jag godkänner Evoice :terms',
    ...
    'pro_plan_success' => 'Tack för att du väljer Evoice\'s Pro!<p/>&nbsp;<br/>
    ...
    'app_description' => 'Evoice är en gratis, öppen programvarulösning för fakturering av kunder. Med Evoice kan ni lätt skapa och skicka snygga fakturor från vilken teknisk utrustning som helst som har tillgång till internet. Era kunder kan skriva ut era fakturor, ladda ner dem som pdf-filer, och betala online.',
    'rows' => 'rader',
    'www' => 'www',
    'logo' => 'Logotyp',
    ...
    'pro_plan_feature4' => 'Radera "Skapad av Evoice"',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort Evoice referens från faktura och klient portal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort Evoice-logotypen genom att uppgradera till Pro nivå',
    ...
    'pro_plan_year_description' => 'Ett års registering på Evoice Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på Evoice Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på Evoice Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på Evoice Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använda JSON om du planerar att importera datan till Evoice.<br/>Filen innehåller kunder, produkter, fakturor, offerter och betalningar.',
    'JSON_file' => 'JSON Fil',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för Evoice',
    ...
    'bot_get_email' => 'Hej! (wave) <br/> Tack för att ni testar Evoice Bot. <br/> Du behöverskapa ett gratiskonto på <a href="https://www.invoiceninja.com">invoiceninja.com</a> för att använda denna bot. <br/> Skicka mig din e-post för att komma igång.',
    ...
    'security_code_email_subject' => 'Säkerhetskod för Evoice Bot.',
    'security_code_email_line1' => 'Detta är din Evoice Bot säkerhetskod.',
    ...
    'update_invoiceninja_title' => 'Uppdatera Evoice',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar Evoice, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av Evoice finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av Evoice finns tillgänglig.',
