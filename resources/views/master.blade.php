...
<head>
    ...
    @else
        <title>{{ isset($title) ? ($title . ' | Evoice') : ('Evoice | ' . trans('texts.app_title')) }}</title>
        <meta name="description" content="{{ isset($description) ? $description : trans('texts.app_description') }}"/>
        <link href="{{ asset('favicon-v2.png') }}" rel="shortcut icon" type="image/png">

        <meta property="og:site_name" content="Evoice"/>
        <meta property="og:url" content="{{ SITE_URL }}"/>
        <meta property="og:title" content="Evoice"/>
        ...
        <meta name="apple-mobile-web-app-title" content="Evoice">
        <meta name="application-name" content="Evoice">
