...
Well, it’s time to bill, and the Invoices function of Evoice lets you get the job done fast and with perfect accuracy.
...
The life of an invoice in the Evoice system is made up of a number of stages:
...
- **Orange button - Email Invoice**: Email the invoice directly via the Evoice system to the email address specified for the client.
