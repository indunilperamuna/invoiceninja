...
The Evoice iPhone and Android applications allows a user to connect to their self-hosted Evoice web application.
...
First, you'll need to add an additional field to your .env file which is located in the root directory of your self-hosted Evoice installation.
...
Save your .env file and now open Evoice on your iPhone.
